...
namespace ProjectUsers
{
    public partial class MainForm : Form
    {
        ...
        public void PanelView()
        {
            ...
            const int spacing = 5;
            int i = 0;
            foreach (var data in dbManager.GetDataFromDatabase("SELECT * FROM People WHERE Name LIKE '%" + txtSearch.Text + "%' OR Surname LIKE '%" + txtSearch.Text + "%' ORDER BY Name, Surname"))
            {
